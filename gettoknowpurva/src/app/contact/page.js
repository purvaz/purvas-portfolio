            ...
            <div className="container mx-auto px-10 py-16 flex items-center justify-center min-h-full">
                <div className="justify-center">
                    ...
                    <div className="flex justify-center mt-5 mr-10 space-x-5">
                        ...
                        <a href="https://scholar.google.com/citations?user=DXTKAG0AAAAJ&hl=en" target="_blank" rel="noopener noreferrer">
                            <ScholarIcon fontSize="large" className="text-purple-800 hover:text-purple-700 cursor-pointer" />
                        </a>
                    </div>
                </div>
            </div>
